  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 offset-md-3">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Modifier admin</h5>
            <form @submit.prevent="submitForm">
              ...
              <div class="form-group">
                ...
                <input type="password" class="form-control" id="password" v-model="form.password" :class="{ 'is-invalid': errors.password }">
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      api.put('/api/admins/'+ this.id, this.form)
        .then(response => {
    ...
    getAdmin() {
      // Submit form logic
      api.get('/api/admins/'+ this.id)
        .then(response => {
          // Handle successful response
           if (response.data.admin){
              this.form.name = response.data.admin.name;
              this.form.email = response.data.admin.email;
           }
        })
        .catch(error => {
            console.log(error);
